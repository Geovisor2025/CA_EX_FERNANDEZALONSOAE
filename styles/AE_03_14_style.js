var size = 0;
var placement = 'point';
function categories_AE_03_14(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'AREA CULTIVADA':
...
var style_AE_03_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_AE_03_14(feature, value, size, resolution, labelText,
